...
describe('Utils', () => {
    ...
    describe('randomInt', () => {
        test('should return integer within range', () => {
            for (let i = 0; i < 100; i++) {
                const result = (0, utils_1.randomInt)(0, 10);
        ...
        test('should handle single value range', () => {
            const result = (0, utils_1.randomInt)(5, 5);
    ...
    describe('randomFloat', () => {
        test('should return float within range', () => {
            for (let i = 0; i < 100; i++) {
                const result = (0, utils_1.randomFloat)(0.0, 1.0);
    ...
    describe('buildWindowSelector', () => {
        test('should build selector with title', () => {
            const result = (0, utils_1.buildWindowSelector)({ title: '微信' });
            expect(result).toBe("Window[@Name='微信']");
        });
        test('should build selector with multiple predicates', () => {
            const result = (0, utils_1.buildWindowSelector)({
                title: '微信',
